...
class UBSBrasilandiaRecordDocumentEquality
    implements Equality<UBSBrasilandiaRecord> {
  const UBSBrasilandiaRecordDocumentEquality();

  @override
  bool equals(UBSBrasilandiaRecord? e1, UBSBrasilandiaRecord? e2) {
    return e1?.local == e2?.local && e1?.nome == e2?.nome;
  }

  @override
  int hash(UBSBrasilandiaRecord? e) =>
      const ListEquality().hash([e?.local, e?.nome]);

  @override
  bool isValidKey(Object? o) => o is UBSBrasilandiaRecord;
}
