...
class UBSJardimEledyRecordDocumentEquality
    implements Equality<UBSJardimEledyRecord> {
  const UBSJardimEledyRecordDocumentEquality();

  @override
  bool equals(UBSJardimEledyRecord? e1, UBSJardimEledyRecord? e2) {
    return e1?.local == e2?.local && e1?.nome == e2?.nome;
  }

  @override
  int hash(UBSJardimEledyRecord? e) =>
      const ListEquality().hash([e?.local, e?.nome]);

  @override
  bool isValidKey(Object? o) => o is UBSJardimEledyRecord;
}
