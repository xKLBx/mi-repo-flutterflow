...
class UBSVilaCisperRecordDocumentEquality
    implements Equality<UBSVilaCisperRecord> {
  const UBSVilaCisperRecordDocumentEquality();

  @override
  bool equals(UBSVilaCisperRecord? e1, UBSVilaCisperRecord? e2) {
    return e1?.local == e2?.local && e1?.nome == e2?.nome;
  }

  @override
  int hash(UBSVilaCisperRecord? e) =>
      const ListEquality().hash([e?.local, e?.nome]);

  @override
  bool isValidKey(Object? o) => o is UBSVilaCisperRecord;
}
