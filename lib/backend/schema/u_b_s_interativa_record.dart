...
class UBSInterativaRecordDocumentEquality
    implements Equality<UBSInterativaRecord> {
  const UBSInterativaRecordDocumentEquality();

  @override
  bool equals(UBSInterativaRecord? e1, UBSInterativaRecord? e2) {
    return e1?.local == e2?.local && e1?.nome == e2?.nome;
  }

  @override
  int hash(UBSInterativaRecord? e) =>
      const ListEquality().hash([e?.local, e?.nome]);

  @override
  bool isValidKey(Object? o) => o is UBSInterativaRecord;
}
