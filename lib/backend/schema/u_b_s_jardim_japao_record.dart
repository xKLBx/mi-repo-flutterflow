...
class UBSJardimJapaoRecordDocumentEquality
    implements Equality<UBSJardimJapaoRecord> {
  const UBSJardimJapaoRecordDocumentEquality();

  @override
  bool equals(UBSJardimJapaoRecord? e1, UBSJardimJapaoRecord? e2) {
    return e1?.local == e2?.local && e1?.nome == e2?.nome;
  }

  @override
  int hash(UBSJardimJapaoRecord? e) =>
      const ListEquality().hash([e?.local, e?.nome]);

  @override
  bool isValidKey(Object? o) => o is UBSJardimJapaoRecord;
}
