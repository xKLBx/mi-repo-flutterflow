...
import 'criandoperfil_model.dart';
export 'criandoperfil_model.dart';

class CriandoperfilWidget extends StatefulWidget {
  const CriandoperfilWidget({Key? key}) : super(key: key);

  @override
  _CriandoperfilWidgetState createState() => _CriandoperfilWidgetState();
}

class _CriandoperfilWidgetState extends State<CriandoperfilWidget> {
  late CriandoperfilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriandoperfilModel());
    ...
    _model.generoController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.genero, ''));
  }
                      ...
                      builder: (context) => Container(
                        ...
                        child: Image.network(
                          valueOrDefault<String>(
                            currentUserPhoto,
                            'https://img.freepik.com/fotos-premium/globo-e-cidade-verde-elementos-desta-imagem-fornecidos-por-nasagenerative-ai_391052-12901.jpg',
                          ),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ...
                    child: Padding(
                      ...
                      child: AuthUserStreamWidget(
                        builder: (context) => TextFormField(
                          ...
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Insira seu endereço residencial:',
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                                  fontFamily: 'Readex Pro',
